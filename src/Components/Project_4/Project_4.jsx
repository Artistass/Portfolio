  ...
  return (
    <div className={styles.container}>
      <div className={styles.descriptionContainer}>
        ...
        <h5 className={styles.descriptionText}>{t("project_description_4")}</h5>
      </div>
      ...
      <div className={styles.imageContainer}>
        ...
        <img
          className={styles.projectImage}
          src="/project_4/Screenshot 2025-02-08 140448.png"
          alt="ProjectImage_1"
        />
        <img
          className={styles.projectImage}
          src="/project_4/Screenshot 2025-02-08 140523.png"
          alt="ProjectImage_3"
        />
      </div>
      <div className={styles.linksContainer}>
        <a className={styles.links} 
        href="https://nimble-dusk-ab9ba2.netlify.app/"
        target="_blank"
        ...
        <a
          ...
          href="https://github.com/Artistass/NFL_Landing.git"
          target="_blank"
          rel="noopener noreferrer"
        >
